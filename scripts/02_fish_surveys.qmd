...
```{r}
biomass_ref_pts <- read_csv(file.path(ps_data_path, "Coral reef reference points/Pacific_fish_biomass_ref_pts.csv")) |> 
  janitor::clean_names() |> 
...
ggsave(tmp, filename = file.path(exp_path, "figures/fish_biomass.png"), height = 15)
```
